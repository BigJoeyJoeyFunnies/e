...
local objs = game:GetObjects("rbxassetid://14214062339")
local import = objs[1]
...
index = {
    ...
    }, 
    {
        name = "snowball",
				offset = CFrame.Angles(math.rad(0), math.rad(0), math.rad(90)),
        model = import:WaitForChild("Snow"),
    },
    {
        name = "arrow",
	offset = CFrame.Angles(math.rad(0), math.rad(0), math.rad(-90)),
        model = import:WaitForChild("arrow"),
    },
    {
		name = "wood_bow",
		offset = CFrame.Angles(math.rad(0), math.rad(0), math.rad(90)),
...
game.Lighting.Sky.SkyboxBk = "http://www.roblox.com/asset/?id=14205718318"
game.Lighting.Sky.SkyboxDn = "http://www.roblox.com/asset/?id=14205760198"
game.Lighting.Sky.SkyboxFt = "http://www.roblox.com/asset/?id=14205726179"
game.Lighting.Sky.SkyboxLf = "http://www.roblox.com/asset/?id=14205744274"
game.Lighting.Sky.SkyboxRt = "http://www.roblox.com/asset/?id=14205721675"
game.Lighting.Sky.SkyboxUp = "http://www.roblox.com/asset/?id=14205734498"
game.Lighting.Sky.MoonTextureId = "http://www.roblox.com/asset/?id= "
game.Lighting.Sky.SunTexturePackId = "http://www.roblox.com/asset/?id= "
